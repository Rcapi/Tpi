        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                using (CDatos.FerreteriaEntities db = new CDatos.FerreteriaEntities())
                {
                    ...
                    CDatos.ElementoDeSujecion elementoDeSujecionExistente = db.ElementoDeSujecions.FirstOrDefault(p => p.Codigo == codigo);
                    ...
                    else
                    {
                        ...
                        CDatos.ElementoDeSujecion nuevoElementoDeSujecion = new CDatos.ElementoDeSujecion
                        {
                            Codigo = txtCodigo.Text,
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                using (CDatos.FerreteriaEntities db = new CDatos.FerreteriaEntities())
                {
                    ...
                    CDatos.ElementoDeSujecion nuevoElementoDeSujecion = db.ElementoDeSujecions.FirstOrDefault(p => p.Codigo == codigo);
