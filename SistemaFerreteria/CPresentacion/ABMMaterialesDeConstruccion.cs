        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                using (FerreteriaEntities db = new FerreteriaEntities())
                {
                    ...
                    MaterialDeConstruccion MaterialDeConstruccionAEliminar = db.MaterialDeConstruccions.FirstOrDefault(p => p.Codigo == codigo);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                using (FerreteriaEntities db = new FerreteriaEntities())
                {
                    ...
                    MaterialDeConstruccion MaterialDeConstruccionExistente = db.MaterialDeConstruccions.FirstOrDefault(p => p.Codigo == codigo);
                    ...
                    else
                    {
                        ...
                        MaterialDeConstruccion nuevoMaterial = new MaterialDeConstruccion
                        {
                            Codigo = txtCodigo.Text,
                            Marca = txtMarca.Text,
